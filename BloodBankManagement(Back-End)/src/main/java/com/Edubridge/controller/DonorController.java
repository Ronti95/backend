...
import com.Edubridge.model.BloodDetails;
import com.Edubridge.model.Donor;
import com.Edubridge.model.Requesting;
import com.Edubridge.model.User;
import com.Edubridge.service.DonorService;
import com.Edubridge.service.RegistrationService;
...
public class DonorController
{
	...
	public ResponseEntity<List<Integer>> getTotalDonationCount(@PathVariable String email) throws Exception
	{
		...
		{
			if(val.getName().equalsIgnoreCase("Rohan"))
				count++;
		}
		al.add(count);
		return new ResponseEntity<List<Integer>>(al, HttpStatus.OK);
